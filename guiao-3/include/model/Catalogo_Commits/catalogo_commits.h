...
/**
 * Função que obtém a hashtable de ocorrências
 * @param ccommits O Catálogo de Commits
 * @return GHashtable com o número de commits de cada user
 */
GHashTable * get_hashOcor(CCOMMITS ccommits);

/**
 * Função que obtém o garray com os ids dos users
 * @param ccommits O Catálogo de Commits
 * @return o garray de ids
 */
GArray * get_CC_usersID(CCOMMITS ccommits);

/**
 * Função que faz um append de um inteiro ao garray
 * @param ccommits O Catálogo de Commits
 * @param x é o número do id de um user
 */
...
/**
 * Função que adiciona uma ocorrencia ao parâmetro key na ghashtable
 * @param key é o número id de um user
 */
