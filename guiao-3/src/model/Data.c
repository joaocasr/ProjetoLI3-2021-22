...
int Calendario_Compere(LCalendario inicio, LCalendario fim, LCalendario atual) {
    ...
    if (atual->ano < inicio->ano || atual->ano > fim->ano)
        valid = 0;
    else if ((atual->ano == inicio->ano && atual->mes < inicio->mes) ||
             (atual->ano == fim->ano && atual->mes > fim->mes))
        valid = 0;
    else if ((atual->ano == inicio->ano && atual->mes == inicio->mes && atual->dia < inicio->dia) ||
             (atual->ano == fim->ano && atual->mes == fim->mes && atual->dia > fim->dia))
        valid = 0;
